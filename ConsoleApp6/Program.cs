...
class MainClass
{
    ...
    {
        var User = GetData();
        ShowData(User.Item1, User.Item2, User.Item3, User.Item4, User.Item5, User.Item6);
    ...
    static void ShowData(string Name, string Surname, int Age, bool HavePet, int Pets, string[] PetNames)
    {
